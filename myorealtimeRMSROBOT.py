...
model1 = joblib.load('jempolNaufalRMS.pkl')
model2 = joblib.load('telunjukNaufalRMS.pkl')
model3 = joblib.load('tengahNaufalRMS.pkl')
model4 = joblib.load('manisNaufalRMS.pkl')
model5 = joblib.load('kelingkingNaufalRMS.pkl')
